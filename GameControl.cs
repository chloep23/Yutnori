...
{    
    ...
    public static bool cornerAllowed = false;
    public static bool P1LeftCornerTurn = false;
    public static bool P2LeftCornerTurn = false;
    public static bool P1RightCornerTurn = false;
    public static bool P2RightCornerTurn = false;
    public static bool P1ButtonStop = false;
    public static bool P2ButtonStop = false;
    ...
    //Top Right Corner Route Code - 
        ...
        if (rightCorner1 == true && perMovePositionP1 == 6 && UltimateStick.whosTurn == 1){
            P1RightCornerTurn = true;
        }

        if (P1RightCornerTurn == true && UltimateStick.whosTurn == -1) {
            P1ButtonStop = true;
            CC7.gameObject.SetActive(true);
            CC22.gameObject.SetActive(true);
        }

        if (P1ButtonStop == true && UltimateStick.whosTurn == 1){
            UltimateStick.coroutineAllowed = false;
        ...
        if (rightCorner2 == true && perMovePositionP2 == 6 && UltimateStick.whosTurn == -1)
        {
            P2RightCornerTurn = true;
        }

        if (P2RightCornerTurn == true && UltimateStick.whosTurn == 1)
        {
            P2ButtonStop = true;
            CC7.gameObject.SetActive(true);
            CC22.gameObject.SetActive(true);
        ...
        if (P2ButtonStop == true && UltimateStick.whosTurn == -1)
        {
            UltimateStick.coroutineAllowed = false;
            UltimateStick.whosTurn = 1;
        }
        ...
        //Diagonal Line Option For Player2:  
            //Remaining Moves:
        if (rightPathP2 == true && player2.GetComponent<FollowThePath>().waypointIndex < 21 + stickSideThrown){
           player2.GetComponent<FollowThePath>().moveAllowed = true;
           CC7.gameObject.SetActive(false);
           CC22.gameObject.SetActive(false);
           rightCorner2 = false;
    ...
    //Top Left Corner Route Code - 
        ...
        if (leftCorner1 == true && perMovePositionP1 == 11 && UltimateStick.whosTurn == 1)
        {
            P1LeftCornerTurn = true;
        }

        if (P1LeftCornerTurn == true && UltimateStick.whosTurn == -1)
        {
            P1ButtonStop = true;
        ...
        if (leftCorner2 == true && perMovePositionP2 == 11 && UltimateStick.whosTurn == -1)
        {
            P2LeftCornerTurn = true;
        }

        if (P2LeftCornerTurn == true && UltimateStick.whosTurn == 1)
        {
            P2ButtonStop = true;
            CC12.gameObject.SetActive(true);
            CC33.gameObject.SetActive(true);
        ...
        //Diagonal Line Option For Player2:  
            //Remaining Moves:
        if (leftPathP2 == true && player2.GetComponent<FollowThePath>().waypointIndex < 32 + stickSideThrown){
           player2.GetComponent<FollowThePath>().moveAllowed = true;
           CC12.gameObject.SetActive(false);
           CC33.gameObject.SetActive(false);
           leftCorner2 = false;
    ...
    //Stop Player 1 Movement Code -      
        if (player1.GetComponent<FollowThePath>().waypointIndex > player1StartWaypoint + stickSideThrown){
            ...
            if (perMovePositionP2 == perMovePositionP1){
                ...
                leftPathP2 = false;
                validWinP2 = false;
                P2LeftCornerTurn = false;
                P2RightCornerTurn = false;
                P2ButtonStop = false;
            }
    ...
    //Stop Player 2 Movement Code -     
        if (player2.GetComponent<FollowThePath>().waypointIndex > player2StartWaypoint + stickSideThrown){
            ...
            if (perMovePositionP1 == perMovePositionP2){
                ...
                leftPathP1 = false;
                validWinP1 = false;
                P1LeftCornerTurn = false;
                P1RightCornerTurn = false;
                P1ButtonStop = false;
            }
            player2MoveText.gameObject.SetActive(false);
            player1MoveText.gameObject.SetActive(true);
